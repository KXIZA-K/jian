...
use jian_widgets::{Color, ImageAdjustments, ImageBlendMode, Point2D, Rect};
#[path = "layout_scene_image.rs"]
mod image_fit;
...
pub struct SceneNode {
    ...
    /// viewport transform.
    pub bounds: Rect,
    /// HTML source-root origin for paint-only CSS pixel alignment.
    pub css_paint_origin: Option<Point2D>,
    /// Source-requested grayscale text; false leaves backend selection intact.
